...
class HabitController {
    ...
    var defaultHabits: [Habit] = [
        ...
        Habit(title: "Took the bus", iconUID: "bus", co2Value: 0.353, identifier: 5, source: "https://www.transit.dot.gov/sites/fta.dot.gov/files/docs/PublicTransportationsRoleInRespondingToClimateChange2010.pdf", fact: "Taking public transport could lower your carbon footprint by 2177kgs annually."),
        Habit(title: "Took the train", iconUID: "train", co2Value: 0.390, identifier: 6, source: "https://www.transit.dot.gov/sites/fta.dot.gov/files/docs/PublicTransportationsRoleInRespondingToClimateChange2010.pdf", fact: "Taking public transport could lower your carbon footprint by 2177kgs annually."),
        ...
        Habit(title: "Buy used clothing", iconUID: "reuse", co2Value: 5.9, identifier: 12, source: "https://gaiaandglobalwarming.wordpress.com/about/re-using-clothes-saves-co2/", fact: "If every American bought one used item instead of new, it would be equivalent to removing half a million cars off the road for a year!")
    ]
